...
void Fighting::play(){
    ...
    system("cls");
        ...
        cout << "\n\n\n\tSie haben die m""\x84""glichkeit eine Waffe zu waehlen: \n"; 
        ...
        fChoice = getch();
        if(fChoice == '1'){
            cout << "\n\nSie haben sich für die Faust entschieden mit [" << weap.fist << " +" <<"] Angriff und [" << speed.fSpeed<< " +" << "] speed\n";
        } else if ( fChoice == '2'){
            cout << "\nSie haben sich für das Messer entschieden mit [" << weap.knife << " +" <<"] Angriff und [" << speed.kSpeed <<" +" << "] speed\n";
        } else if (fChoice == '3'){
            cout << "Sie haben sich für für den Stock entschieden mit [" << weap.stick << " +" <<"] Angriff und [" << speed.sSpeed << " +" <<"] speed\n\n";
        } else {
