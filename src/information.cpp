...
void Infos::showInfos(){
    ...
    cout << "\t\t\twarum C++ und keine andere Sprache? Mir gef""\x84""llt die Syntax        " << endl;
    ...
    cout << "\t\t\tfr""\x81""her war es haupts""\x84""chlich das Gaming, heute mit sehr viel Spa""\341"",\n\t\t\tdas Programmieren in C++!" << endl;
    cin.get();   
    }while(!infoChoice);
}